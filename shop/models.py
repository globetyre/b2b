...
class Product(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Netto [PL]")
    price_ue = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name="Netto [UE]")
